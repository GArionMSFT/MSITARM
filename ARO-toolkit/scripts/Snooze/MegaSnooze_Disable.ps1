...
try
{
    Write-Output "Performing the MegaSnooze Disable..."

    Write-Output "Collecting all the schedule names for MegaSnooze..."
    ...
    Write-Output "Disabling the schedules for MegaSnooze..."

    #Disable the schedule for MegaSnooze
    ...
    Write-Output "Calling child runbook to disable the alert all the VM's..."    
    ...
    Write-Output "MegaSnooze disable execution completed..."
