...
$threshold = Get-AutomationVariable -Name 'External_MegaSnooze_Threshold'
$metricName = Get-AutomationVariable -Name 'External_MegaSnooze_MetricName'
$timeWindow = Get-AutomationVariable -Name 'External_MegaSnooze_TimeWindow'
$condition = Get-AutomationVariable -Name 'External_MegaSnooze_Condition' # Other valid values are LessThanOrEqual, GreaterThan, GreaterThanOrEqual
$description = Get-AutomationVariable -Name 'External_MegaSnooze_Description'
$timeAggregationOperator = Get-AutomationVariable -Name 'External_MegaSnooze_TimeAggregationOperator'
